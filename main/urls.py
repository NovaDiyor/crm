...
urlpatterns = [
    ...
    path('rooms/', room_view, name='room'),
    path('rooms/add/', add_room, name='add-rooms'),
    ...
    path('food/get/<int:pk>/', get_menu, name='get-menu'),
    path('info/get/<int:pk>/', get_info, name='get-info'),
    path('image/get/<int:pk>/', get_img, name='get-img'),
