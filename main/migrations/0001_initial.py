# Generated by Django 4.1 on 2022-12-05 04:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'admin'), (2, 'staff'), (3, 'user')], default=3)),
                ('phone', models.IntegerField(blank=True, null=True)),
                ('passport', models.CharField(blank=True, max_length=210, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main.description')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(choices=[(1, '1-start'), (2, '2-start'), (3, '3-start'), (4, '4-start'), (5, '5-start')])),
                ('ads', models.ManyToManyField(to='main.ads')),
                ('img', models.ManyToManyField(to='main.hotelimage')),
